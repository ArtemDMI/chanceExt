...
test('formats one plan line and appends it after the user turn', () => {
    ...
    assert.equal(
        ...
        'ВАЖНО!!! Адаптируй свой ответ под следующий план-структура сюжета: 1. [паника] - 2. [ ] - 3. [разговор] - 4. [тишина] - 5. [шаг] - 6. [дверь] - 7. [свет] - 8. [голос] - 9. [выбор] - 10. [ ]. Структура рекомендательная и абстрактная, подлежит очень широкой свободной интерпретации. Допускается пропускать нелогичные и не соответствующие логике и сюжету пункты, но не более 30%. Не выходи из роли.',
    );

    const line = formatPlanLine(nodes);
    assert.equal(
        line,
        'ВАЖНО!!! Адаптируй свой ответ под следующий план-структура сюжета: 1. [паника] - 2. [разговор] - 3. [тишина] - 4. [шаг] - 5. [дверь] - 6. [свет] - 7. [голос] - 8. [выбор] - 9. [бег] - 10. [внезапные события]. Структура рекомендательная и абстрактная, подлежит очень широкой свободной интерпретации. Допускается пропускать нелогичные и не соответствующие логике и сюжету пункты, но не более 30%. Не выходи из роли.',
    );
